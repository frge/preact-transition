...
(function (preact) {
  ...
  var Transition = (function (Component) {
    ...
    Transition.prototype.render = function render (props, ref$1) {
      ...
      return preact.h(component || 'div', attrs);
    };

    return Transition;
  }(preact.Component));

  var Dialog = (function (Component) {
    function Dialog(props) {
      Component.call(this, props);
      this.state.mode = 'out';
    }

    if ( Component ) Dialog.__proto__ = Component;
    Dialog.prototype = Object.create( Component && Component.prototype );
  ...
  var Switch = (function (Component) {
    ...
    Switch.prototype.render = function render (props, state) {
      var this$1 = this;
